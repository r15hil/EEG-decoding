...
DEFAULT_FILENAME = "/Users/rishil/Desktop/FYP/EEG-decoding/eeg_lib/logs/downsample10hznocompress.json"

stim_freqs = [7,10,12] # stim freqs used
fs = 256 # sampling freq
Ns = 64 # number of sample points to consider
...
def calibrate():
    ...
    for f, test_set in tests.items():
        ...
        for test in test_set:
            ...
            proc_calibration[f].append(proc_data[:, :Ns].reshape((1, Ns, -1))) # exclude first trial
...
def decoding():
    ...
    decode_data = np.array(decode_data['raw_data_downsampled']).reshape(1,Ns)
